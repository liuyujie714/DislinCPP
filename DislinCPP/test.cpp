/**
 * examples.cpp  ¡ª  DislinPlot usage examples
 *
 * Compile (Linux):
 *   g++ -std=c++17 -O2 -I/usr/local/dislin -o examples examples.cpp \
 *       -L/usr/local/dislin -ldislin -lX11 -lm
 */
...
void example_scatter()
{
    ...
    plt.scatter(x1, y1, "red", 20, "Cluster A");
...
int main()
{
    std::cout << "DislinPlot ¡ª C++ wrapper for DISLIN\n";
